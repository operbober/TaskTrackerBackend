...
@Component
public class InviteSenderChecker implements PermissionChecker<InviteIdDTO> {

    @Autowired
    private InviteService inviteService;

    @Override
    public boolean checkPermission(User user, @Valid InviteIdDTO inviteIdDTO) throws Exception {
        ...
        return invite.getProject().getOwner().getId().equals(user.getId());
    }
}
